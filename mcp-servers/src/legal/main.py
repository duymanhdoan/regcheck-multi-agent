"""Legal MCP server main entry point."""
...
from .legal_server import LegalMCPServer
...
mcp_server: LegalMCPServer = None
...
async def lifespan(app: FastAPI):
    ...
    mcp_server = LegalMCPServer(s3_client=s3_client)
...
app = FastAPI(
    ...
    description="MCP server for Legal department data and tools",
    version="1.0.0",
    lifespan=lifespan
)
